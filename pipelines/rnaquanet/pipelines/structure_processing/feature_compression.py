...
def compress_adeine_features(df: pd.DataFrame, BASE_PATH: str) -> pd.DataFrame:
...
def compress_cytosine_features(df: pd.DataFrame, BASE_PATH: str) -> pd.DataFrame:
    if torch.cuda.is_available():
...
def compress_uracil_features(df: pd.DataFrame, BASE_PATH: str) -> pd.DataFrame:
    if torch.cuda.is_available():
...
def compress_guanine_features(df: pd.DataFrame, BASE_PATH: str) -> pd.DataFrame:
    if torch.cuda.is_available():
